import { User, LinkedAccount, LinkedAccountEmbeddedWallet, LinkedAccountEthereumEmbeddedWallet, LinkedAccountSolanaEmbeddedWallet, LinkedAccountBitcoinSegwitEmbeddedWallet, LinkedAccountBitcoinTaprootEmbeddedWallet, LinkedAccountSmartWallet } from '@privy-io/api-types';
...
/** @deprecated use the {@link LinkedAccount.LinkedAccountEmail} type instead. */
type PrivyEmailAccount = LinkedAccount.LinkedAccountEmail;
/** @deprecated use the {@link LinkedAccount.LinkedAccountPhone} type instead. */
type PrivyPhoneAccount = LinkedAccount.LinkedAccountPhone;
/** @deprecated use the {@link LinkedAccount.LinkedAccountEthereum} type instead. */
type PrivyEthereumAccount = LinkedAccount.LinkedAccountEthereum;
/** @deprecated use the {@link LinkedAccount.LinkedAccountSolana} type instead. */
type PrivySolanaAccount = LinkedAccount.LinkedAccountSolana;
/** @deprecated use the {@link LinkedAccount.LinkedAccountGoogleOAuth} type instead. */
type PrivyGoogleOauthAccount = LinkedAccount.LinkedAccountGoogleOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountTwitterOAuth} type instead. */
type PrivyTwitterOauthAccount = LinkedAccount.LinkedAccountTwitterOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountDiscordOAuth} type instead. */
type PrivyDiscordOauthAccount = LinkedAccount.LinkedAccountDiscordOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountGitHubOAuth} type instead. */
type PrivyGithubOauthAccount = LinkedAccount.LinkedAccountGitHubOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountSpotifyOAuth} type instead. */
type PrivySpotifyOauthAccount = LinkedAccount.LinkedAccountSpotifyOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountInstagramOAuth} type instead. */
type PrivyInstagramOauthAccount = LinkedAccount.LinkedAccountInstagramOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountTiktokOAuth} type instead. */
type PrivyTiktokOauthAccount = LinkedAccount.LinkedAccountTiktokOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountLinkedInOAuth} type instead. */
type PrivyLinkedInOauthAccount = LinkedAccount.LinkedAccountLinkedInOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountAppleOAuth} type instead. */
type PrivyAppleOauthAccount = LinkedAccount.LinkedAccountAppleOAuth;
/** @deprecated use the {@link LinkedAccount.LinkedAccountCustomJwt} type instead. */
type PrivyCustomJwtAccount = LinkedAccount.LinkedAccountCustomJwt;
/** @deprecated use the {@link LinkedAccount.LinkedAccountFarcaster} type instead. */
type PrivyFarcasterAccount = LinkedAccount.LinkedAccountFarcaster;
/** @deprecated use the {@link LinkedAccount.LinkedAccountPasskey} type instead. */
type PrivyPasskeyAccount = LinkedAccount.LinkedAccountPasskey;
/** @deprecated use the {@link LinkedAccount.LinkedAccountTelegram} type instead. */
type PrivyTelegramAccount = LinkedAccount.LinkedAccountTelegram;
/** @deprecated use the {@link LinkedAccount.LinkedAccountCrossApp} type instead. */
type PrivyCrossAppWalletAccount = LinkedAccount.LinkedAccountCrossApp;
type OAuthFlowState = {
    status: 'initial';
} | {
    status: 'loading';
